...
function SetchainID {
echo " "
echo -e "\e[1m\e[32mConfigure chain id okp4-nemeton-1 and keyring-backend test... \e[0m" && sleep 1
source $HOME/.bash_profile
...
echo -e "\e[1m\e[32mDownload addrbook.json... \e[0m" && sleep 1
...
echo " "
echo -e "\e[1m\e[32mConfigure seeds and peers... \e[0m" && sleep 1
SEEDS=""
...
function Setpruning {
echo " "
echo -e "\e[1m\e[32mConfigure Pruning... \e[0m" && sleep 1
...
source $HOME/.bash_profile
echo -e "\e[1m\e[31mPlease write your mnemonic phrase. \e[0m" && sleep 1
echo " "
...
function Restart {
echo " "
echo -e "\e[1m\e[32mRestart your node ... \e[0m" && sleep 1
sudo systemctl restart okp4d
}
...
source $HOME/.bash_profile 
echo -e "\e[1m\e[32myour node Latest Block is $(curl -s localhost:${OKP4_PORT}657/status | jq .result.sync_info.latest_block_height) \e[0m" 
echo -e "\e[1m\e[32myour node sync is $(curl -s localhost:${OKP4_PORT}657/status | jq .result.sync_info.catching_up) \e[0m" 
}

function Addwallet {
echo " "
echo -e "\e[1m\e[32mCreate your wallet... \e[0m" && sleep 1
...
echo " "
echo -e "\e[1m\e[33myourr okp4 Wallet address : $(okp4d keys show ${OKP4WALLET} -a)\e[0m" && sleep 1
echo -e "\e[1m\e[34myourr okp4 Validator address : $(okp4d keys show ${OKP4WALLET} --bech val -a)\e[0m" && sleep 1      
echo 'export OKP4WALLET_ADDRESS='$(okp4d keys show ${OKP4WALLET} -a) >> $HOME/.bash_profile
echo 'export OKP4VALOPER_ADDRESS='$(okp4d keys show ${OKP4WALLET} --bech val -a) >> $HOME/.bash_profile
...
echo " "
echo -e "\e[1m\e[32mCheck your balance... \e[0m" && sleep 1
source $HOME/.bash_profile
echo -e "\e[1m\e[32myour Balance is $(okp4d query bank balances $OKP4WALLET_ADDRESS) \e[0m" 
...
function Delegate {
echo " "
echo -e "\e[1m\e[32mDelegate Token to your validator ... \e[0m" && sleep 1
YBalance=$(source $HOME/.bash_profile && okp4d query bank balances $OKP4WALLET_ADDRESS  |grep amount |awk -F"\"" '{print $2}')
echo "your utia Balance $YBalance"
echo -e "\e[1m\e[34myour utia Balance : ${YBalance}\e[0m" && sleep 1
echo " "
echo " "
...
function Delete {
echo " "
echo -e "\e[1m\e[32mDelete your node ... \e[0m" && sleep 1
...
PS3='Please enter yourr choice (input yourr option number and press enter): '
...
do
    case $opt in
        "Install")
            echo -e '\e[1m\e[32myour choose Install without Snapshort ...\e[0m' && sleep 1
...
Restart
Addwallet
echo -e "\e[1m\e[32myourr Node was Install!\e[0m" && sleep 1
break
;;

"Install with Snapshot")
            echo -e '\e[1m\e[32myour choose Install with Snapshort ...\e[0m' && sleep 1
InstallingRequiredtool
InstallingGo
InstallingOKP4
installCosmovisor
...
"Check Sync")
            echo -e '\e[1m\e[32myour choose Check Sync ...\e[0m' && sleep 1
Checksync

;;

"Check Balance")
            echo -e '\e[1m\e[32myour choose Check Balance ...\e[0m' && sleep 1
Checkbalances
...
"Custom Port")
            echo -e '\e[1m\e[32myour choose Custom Port ...\e[0m' && sleep 1
CustomPort

;;

"Snapshort")
            echo -e '\e[1m\e[32myour choose Download Snapshot ...\e[0m' && sleep 1
Syncsnap
...
"Create Validator")
echo -e '\e[1m\e[32myour choose Create Validator ...\e[0m' && sleep 1
CreateValidator
echo -e "\e[1m\e[34myourr okp4 Validator address : $(okp4d keys show ${OKP4WALLET} --bech val -a)\e[0m" && sleep 1
...
"Restart")
echo -e '\e[1m\e[32myour choose Restart your Node ...\e[0m' && sleep 1
Restart
echo -e "\e[1m\e[32mRestart your Node complete!\e[0m" && sleep 1


;;

"Delegate")
echo -e '\e[1m\e[32myour choose Delegate ...\e[0m' && sleep 1
Delegate
...
"Uninstall")
echo -e '\e[1m\e[32myour choose Uninstall ...\e[0m' && sleep 1
Delete
echo -e "\e[1m\e[32myourr Node was Uninstall complete!\e[0m" && sleep 1
break
;;
